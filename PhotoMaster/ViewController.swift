...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBAction func tappedAlbum() {
        presentPickerController(sourceType: .photoLibrary)
    }
    
    @IBAction func tappedText() {
    ...
    func drawMaskImage(image: UIImage) -> UIImage {
        ...
        let maskRect = CGRect(x: image.size.width - maskImage.size.width - margin, y: image.size.height - maskImage.size.height - margin, width: maskImage.size.width, height: maskImage.size.width)
